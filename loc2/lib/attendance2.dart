...
class EndAttendance extends StatefulWidget {
  String user;
  EndAttendance({Key key, @required this.user}) : super(key: key);
  @override
  _EndAttendanceState createState() => _EndAttendanceState(user: user);
}

class _EndAttendanceState extends State<EndAttendance> {
  var user;
  bool imagecorr=false;
  String imagemsg='Face not found. Please try again';
  _EndAttendanceState({Key key, @required this.user});
  @override
                ...
                if (snapshot.data['start'] == true &&
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      SizedBox(height: 20),
                      Text(
                        'Ending attendance already given.Thank you ' ,
                        textAlign: TextAlign.center,
                        style: TextStyle(fontSize: 20),
                      ),
                    ],
    ...
    return Container(
      ...
      children: <Widget>[
        ...
        imagemsg=='Face not found. Please try again'?RaisedButton(
          ...
          child: Text('Upload image for recog',style: TextStyle(fontSize: 18),),
        ):Icon(IconData(0xe5ca, fontFamily: 'MaterialIcons'),),
        SizedBox(height: 20,child: Text(imagemsg),),
        RaisedButton(
        ...
        SizedBox(height: 20,child: viscinity=='Not in Vicinity'?Text('text $viscinity'):Container(),),
        Padding(
  ...
  String viscinity = 'Not in viscinity';
  var currentloc;
  double distance;
